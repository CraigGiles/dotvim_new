"
" VIM plugin containing various functions that I find particularly useful.
" 
" Version 1.00
...
if exists("gilesc_functions")
    finish
endif
let gilesc_functions = 1
...
function! GuiVimRunFullscreen()
    ...
    if has('gui_macvim')
      let l:num_columns = &columns
      let l:num_lines = &lines

      if exists('g:max_columns') && l:num_columns==g:max_columns 
        set columns=g:old_columns
        set lines=g:old_lines
        ...
        set columns=1000
        set lines=300
        set g:max_columns = &columns
        set g:max_lines = &lines
      endif
